    ...
    >
      ...
      <Link  className="nav-link resume">
        ...
        id="resume-button-1"
          ...
          target="_blank" bg="brand_secondary" color="#f8572f" _hover={{bg: "gray.200", color:"#e4512d" }} href="https://drive.google.com/file/d/1LeOXFHuxYfQcLOONpppl9hEU3wBT2jPE/view?usp=sharing" download={true}
