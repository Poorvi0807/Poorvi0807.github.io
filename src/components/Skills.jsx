      ...
      <Box id='skill-container-inner'  className="skills-card"  >
        ...
        <Box id='skills_right'  className="skills-card-name" >
          {skillshow ? (<Box id='right_real'  >
            ...
            <img  className='skills-card-img' src="https://img.freepik.com/free-vector/frontend-development-concept-website-interface-design-improvement-web-page-programming-coding-testing-it-profession-isolated-flat-vector-illustration_613284-2357.jpg?w=740&t=st=1702230832~exp=1702231432~hmac=00ad63bb23169bfeb2a2dfa5ebb2c1ca7d316f55d13a2acaf069d4c38c3c2f97" alt="front end" />
          </Box>)}
