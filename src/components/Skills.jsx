...
export const Skills = () => {
  ...
  return (
    <Box id="skills">
      ...
      >
        <span style={{ color: "black", fontWeight: "400" }}>Technical </span>
        Skills{" "}
      </Text>
      ...
      >
        <Button
          ...
          mb={"10px"}
          textAlign={"center"}
          onClick={() => setSkillShow((p) => !p)}
          _hover={{ bg: "gray.900", color: "orangered", borderRadius: "10px" }}
          color={"white"}
          bg={"orangered"}
        >
          {skillshow ? "See Front" : " See Back"}
          End
        </Button>
      </Text>
      ...
      <Box id="skill-container-inner" className="skills-card">
              ...
              >
                ...
                <Box>
                  ...
                  <img
                    className="skills-card-img"
                    id="fontSkill_img"
                    src="https://img.freepik.com/free-icon/css_318-698167.jpg"
                    alt="css3"
                  />{" "}
                  <Text className="skills-card-name" id="skillName">
                    CSS
        ...
        <Box id="skills_right" className="skills-card-name">
          {skillshow ? (
            <Box id="right_real">
              <Text className="skillNameTitle" mb={"20px"} border={"1px solid"}>
                Back End{" "}
              </Text>
              <Box
                className="back_end_skills"
              ...
              >
                <Box>
                  ...
                  <img
                    className="skills-card-img"
                    id="backEnd_img"
                    src="https://openautomationsoftware.com/wp-content/uploads/2016/07/JSON-icon-2.jpg"
                    alt="JSON"
                  />{" "}
                  <Text className="skills-card-name" id="skillName">
                    {" "}
                ...
                <Box>
                  ...
                  <img
                    className="skills-card-img"
                    id="backEnd_img"
                    src="https://cdn-icons-png.flaticon.com/512/1183/1183669.png"
                    alt="java"
                  />{" "}
                  <Text className="skills-card-name" id="skillName">
                    {" "}
                ...
                <Box>
                  <img
                    className="skills-card-img"
                    id="backEnd_img"
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR81s2BetKvsvix5szaKt2gQyX12huNnD7TdA&usqp=CAU"
                    alt="express"
                  />{" "}
                  <Text className="skills-card-name" id="skillName">
                    {" "}
                ...
                <Box>
                  ...
                  <img
                    className="skills-card-img"
                    id="backEnd_img"
                    src="https://ih1.redbubble.net/image.3481290663.8913/st,small,507x507-pad,600x600,f8f8f8.jpg"
                    alt="nodejs"
                  />{" "}
                  <Text className="skills-card-name" id="skillName">
                    {" "}
            ...
            <Box className="right_dup" data-aos="fade-down">
              <img
                className="skills-card-img"
                src="https://img.freepik.com/free-vector/frontend-development-concept-website-interface-design-improvement-web-page-programming-coding-testing-it-profession-isolated-flat-vector-illustration_613284-2357.jpg?w=740&t=st=1702230832~exp=1702231432~hmac=00ad63bb23169bfeb2a2dfa5ebb2c1ca7d316f55d13a2acaf069d4c38c3c2f97"
                alt="front end"
              />
            </Box>
          )}
        ...
        <Box className="OtherSkills-inner">
          ...
          <Box data-aos="flip-right" data-aos-duration="1500">
            <img
              className="skills-card-img"
              id="tool_skill_img"
              src="https://img.icons8.com/?size=1x&id=LoL4bFzqmAa0&format=png"
              alt=""
            />{" "}
            <Text className="skills-card-name" id="skillName">
              Github
          ...
          <Box data-aos="flip-right" data-aos-duration="1500">
            <img
              className="skills-card-img"
              id="tool_skill_img2"
              src="https://cdn.wmaraci.com/nedir/json.png"
              alt=""
            />{" "}
            <Text className="skills-card-name" id="skillName">
              JSON
